...
export class GencyController {
  ...
  @Post('ideas')
  async getIdeas(@Body() dto: GenerateIdeaDto): Promise<string[]> {
  ...
  @Post('blog')
  async getBlog(@Body() dto: GenerateBlogContentDto): Promise<Blog> {
    return await this.gencyService.getBlog(
      dto.productInfo,
      dto.mood,
      dto.title,
    );
  ...
  @Post('post')
  async getPost(@Body() dto: GenerateShortPostDto): Promise<ShortPost> {
    return await this.gencyService.getPost(
      dto.productInfo,
      dto.mood,
      dto.purpose,
    );
